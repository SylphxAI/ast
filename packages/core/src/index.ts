...
export interface LinkLabelStart extends Token {
	type: 'LinkLabelStart'
} // '['
export interface LinkLabelEnd extends Token {
	type: 'LinkLabelEnd'
} // ']'
export interface LinkUrlStart extends Token {
	type: 'LinkUrlStart'
} // '('
export interface LinkUrlEnd extends Token {
	type: 'LinkUrlEnd'
} // ')'
